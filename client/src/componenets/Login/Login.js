                    ...
                    <div className="center-wrap">
                      <div className="section text-center">
                        ...
                        <div className="form-group">
                          <input type="text" name="logemail" className="form-style" placeholder="Your username" id="logemail1" autoComplete="off" onChange={(e) => setUserName(e.target.value)} />
                          <i className="input-icon uil uil-at"></i>
                        </div>
                        <div className="form-group mt-2">
                          <input type="password" name="logpass" className="form-style" placeholder="Your Password" id="logpass1" autoComplete="off" onChange={(e) => setPassword(e.target.value)} />
                  ...
                  <div className="card-back">
                    <div className="center-wrap">
                      <div className="section text-center">
                        ...
                        <div className="form-group">
                          <input type="text" name="logname" className="form-style" placeholder="Your Full Name" id="logname" autoComplete="off" onChange={(e) => setUserName(e.target.value)} />
                        ...
                        <a href="#" className="btn mt-4" onClick={handleRegister}>
                          submit
                        </a>
                      </div>
                    </div>
