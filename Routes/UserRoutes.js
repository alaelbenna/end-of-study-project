...
const { Login, Register, deleteUserById,  getAllUsers,getUserById, showAllUserInfo,updateUserById, getTotalRegistrations,updateUserByIdProfile } = require("../controllers/user");
